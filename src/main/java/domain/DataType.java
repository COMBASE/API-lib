...
public enum DataType
{
	account("accounts"), accountTransaction("accountTransactions"), assortment("assortments"), cashier("cashiers"), commodityGroup("commodityGroups"), currency(
			...
			"dispatchnotifications"), economicZone("economicZones"), infotext("infotexts"), organizationalUnit("organizationalUnits"), payment("payments"), paymentMethod(
			"paymentMethods"), priceList(
