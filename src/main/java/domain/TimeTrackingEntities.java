...
public class TimeTrackingEntities
{
	...
	private TimeTrackingEntities(final Builder builder)
	{
		name = builder.name;
	...
	public static class Builder
	{
		...
		public Builder paidTime(final boolean value)
		{
			paidTime = value;
			return this;
		}
	...
	public static TimeTrackingEntities fromJSON(JSONObject obj) throws JSONException
	{
		...
		final TimeTrackingEntities tTrackE = new TimeTrackingEntities.Builder(obj.getString("name")).deleted(
