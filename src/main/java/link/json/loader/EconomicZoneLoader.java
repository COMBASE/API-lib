...
public class EconomicZoneLoader extends AbstractHasNameJsonLoader<EconomicZone>
{
	...
	@Override
	public EconomicZone postAndResolve(final EconomicZone obj) throws JSONException, ParseException, KoronaCloudAPIErrorMessageException, InvalidTokenException, ApiNotReachableException
	{
