...
public class AssortmentLoader extends AbstractHasNameJsonLoader<Assortment>
{
	...
	@Override
	public Assortment postAndResolve(final Assortment obj) throws JSONException, ParseException, KoronaCloudAPIErrorMessageException, InvalidTokenException, ApiNotReachableException
	{
