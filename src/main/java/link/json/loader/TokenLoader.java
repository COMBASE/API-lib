...
public class TokenLoader
{
	...
	public String downloadToken(final String appID, final String appSecret, final String userName, final String password) throws ApiNotReachableException, KoronaCloudAPIErrorMessageException
	{
		...
		{
			// TODO check whether where is another way to avoid this method from
			// throwing invalid
			// token
