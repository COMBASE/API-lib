...
public class AccountLoader extends AbstractHasNameJsonLoader<Account>
{
	...
	@Override
	public Account postAndResolve(final Account obj) throws JSONException, ParseException, KoronaCloudAPIErrorMessageException, InvalidTokenException, ApiNotReachableException
	{
