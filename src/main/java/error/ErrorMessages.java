...
public enum ErrorMessages
{
	...
	Invalid_Token("Invalid Token"), No_object_found_for_id("No object found for id"), Input_List_is_empty_or_invalid(
		...
		"articlecode must be unique "), No_object_found_for_revision("No object found for revision"), No_Financial_Accounting_Package(
		"No Financial Accounting Package active");
